...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _styles_main_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../styles/main.scss */ \"./src/styles/main.scss\");\n\r\n\r\n//variables\r\n\r\nlet app = document.getElementById('app')\r\nlet input = document.getElementById('input')\r\nlet items = []\r\nlet addButton = document.getElementById('addItem')\r\nlet ol = document.createElement(\"ol\")\r\n\r\n//get cache\r\nif(localStorage.getItem('items')) {\r\n    let cashedItems = localStorage.getItem('items')\r\n    console.log('got cash');\r\n    items= cashedItems.split(\",\")\r\n}\r\n\r\n\r\n//build list\r\nif(items.length>0) {\r\n    items.forEach(i => {\r\n        addelementLi(i)\r\n    })\r\n    app.append(ol)\r\n} else {\r\n   addelementP(\"create new tasks!\")\r\n}\r\nfunction addelementLi(value) {\r\n    let li = document.createElement('li')\r\n        li.innerHTML= value;\r\n        ol.append(li)\r\n}\r\nfunction addelementP(value) {\r\n    let p = document.createElement('p')\r\n        p.innerHTML= value;\r\n        app.append(p)\r\n}\r\n\r\nfunction addItem() {\r\n    if(input.value.length >2) {\r\n        items.push(input.value)\r\n        if(items.length === 1) {\r\n            app.append(ol)\r\n            let p = document.getElementsByTagName('p')\r\n            p[0].remove()\r\n        }\r\n        addelementLi(input.value)\r\n        localStorage.setItem('items', items);\r\n    } else {\r\n        alert(\"add value\")\r\n    }\r\n}\r\n\r\naddButton.addEventListener('click', e => {\r\n    input = document.getElementById('input')\r\n    addItem()\r\n    input.value = ''\r\n})\r\n\r\nfunction removeItem(id) {\r\n    document.getElementById('id').remove()\r\n}\n\n//# sourceURL=webpack://toDolist/./src/js/script.js?");
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("3c9fbd57f58e7f9c9e30")
/******/ 	})();
/******/ 	
